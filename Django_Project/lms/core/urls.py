...
from core.views import HomePageView,TeacherCreateView, TeacherListView, StudentCreateView, StudentListView, TeacherDeleteView,TeacherDetailView,TeacherUpdateView
